...
namespace Nop.Plugin.Payments.Zelle.Data
{
    ...
    /// </summary>
    public class PaymentZelleObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public PaymentZelleObjectContext(DbContextOptions<PaymentZelleObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new PaymentZelleMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(PaymentZelle));
        }
