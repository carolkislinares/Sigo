...
namespace Nop.Plugin.Payments.SigoCreditos.Validators
{
    public partial class SigoCreditosInfoValidator : BaseNopValidator<SigoCreditosInfoModel>
    {
        public SigoCreditosInfoValidator(ILocalizationService localizationService)
        {
            //useful links:
