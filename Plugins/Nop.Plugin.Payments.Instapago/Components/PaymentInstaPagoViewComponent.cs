...
namespace Nop.Plugin.Payments.InstaPago.Components
{
    [ViewComponent(Name = "PaymentInstaPago")]
    public class PaymentInstaPagoViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.InstaPago/Views/PaymentInfo.cshtml", model);
        }
    }
}
