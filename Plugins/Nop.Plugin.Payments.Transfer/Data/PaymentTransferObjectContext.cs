...
namespace Nop.Plugin.Payments.Transfer.Data
{
    ...
    /// </summary>
    public class PaymentTransferObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public PaymentTransferObjectContext(DbContextOptions<PaymentTransferObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new PaymentTransferMap());
