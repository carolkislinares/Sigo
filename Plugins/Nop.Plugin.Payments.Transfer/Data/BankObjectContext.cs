...
namespace Nop.Plugin.Payments.Transfer.Data
{
    ...
    /// </summary>
    public class BankObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public BankObjectContext(DbContextOptions<BankObjectContext> options) : base(options)
        {
        }
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(Bank));
        }
