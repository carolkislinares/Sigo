...
namespace Nop.Plugin.Payments.Cash.Components
{
    [ViewComponent(Name = "PaymentCash")]
    public class PaymentCashViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.Cash/Views/PaymentInfo.cshtml", model);
        }
    }
}
